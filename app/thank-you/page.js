...
const CONVERSION_MAP = {
  ...
  british: {
    eventName: 'gp_british_gbp',
    currency: 'GBP',
    value: 28,
  },
  america: {
    eventName: 'gp_america_usd',
    currency: 'USD',
    value: 29,
  },
    saudi_arabia: {
    eventName: 'gp_saudi_sar',
    currency: 'SAR',
    value: 30,
  },
  ireland: {
    eventName: 'gp_ireland_eur',
    currency: 'EUR',
    value: 31,
  },
  netherlands: {
    eventName: 'gp_netherlands_eur',
    currency: 'EUR',
    value: 32,
  },
   germany: {
    eventName: 'gp_germany_eur',
    currency: 'EUR',
    value: 33,
  },
  sweden: {
    eventName: 'gp_sweden_sek',
    currency: 'SEK',
    value: 34,
  },
  netherlands: {
    eventName: 'gp_turkey_try',
    currency: 'TRY',
    value: 35,
  },
};
